...
const routes: Routes = [
    {
        ...
        "children": [
          ...
          {
            "path": "media\/addmedia",
            "loadChildren": ".\/pages\/components\/media\/addmedia\/addmedia.module#AddmediaModule"
          },
          {
            "path": "media\/addmedia\/:id",
            "loadChildren": ".\/pages\/components\/media\/addmedia\/addmedia.module#AddmediaModule"
          },
            {
                "path": "media\/media",
								"loadChildren": ".\/pages\/components\/media\/media.module#MediaModule"
            },
